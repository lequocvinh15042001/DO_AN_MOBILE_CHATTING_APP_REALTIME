...
import com.example.doan_appchat.listeners.ConversionListener;
...
public class MainActivity extends AppCompatActivity  implements ConversionListener {
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error)->
    {
        ...
        if(value != null)
        {
            for(DocumentChange documentChange:value.getDocumentChange())
            {
                ...
                }else if(documentChange.getType()== DocumentChange.Type.MODIFIED)
                {
                    for(int i=0;i< conversations.size();i++)
                    {
                        ...
                        {
                            conversations.get(i).message = documentChange.getDocument().geString(Constants.KEY_LAST_MESSAGE);
                            conversations.get(i).dateObject = documentChange.getDocument().geString(Constants.KEY_TIMESTAMP);
                            break;
